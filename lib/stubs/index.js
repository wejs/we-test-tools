...
stubs.messageStub = function termsStub() {
  return {
    content: chancejs.paragraph({sentences: 5})
  }
}

stubs.conferenceStub = function conferenceStub() {
  return {
    ...
    callForPapersStartDate: chancejs.date(),
    callForPapersEndDate: chancejs.date(),
    registrationStartDate: chancejs.date(),
    registrationEndDate: chancejs.date(),
    eventStartDate: chancejs.date(),
    eventEndDate: chancejs.date()
